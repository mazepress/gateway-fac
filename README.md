# MazePress - Gateway FAC
The First Atlantic Commerce (FAC) payment gateway.
...
3. Run `Composer install mazepress/gateway-fac`
...
```json
{
  ...
  "repositories": [
    {
      "type": "vcs",
      "url": "https://github.com/mazepress/gateway-fac.git"
    }
  ],
  "require": {
    "mazepress/gateway-fac": "dev-main"
  },
  "extra": {
    "installer-paths": {
      "packages/{$name}": [
